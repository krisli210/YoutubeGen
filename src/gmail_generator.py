...
def open_firefox():
    ...
    _start_button_=pyautogui.locateOnScreen('images/start_button2.png', confidence = .9)
...
def locate_gmail():
    ...
    _gmail_ = pyautogui.locateOnScreen('images/gmail_form.png', confidence = .9)
    try:
        formx, formy = pyautogui.center(_gmail_)
        pyautogui.click(formx, formy)
    except:
        _gmail_ = pyautogui.locateOnScreen('images/gmail_form1.png')
        formx, formy = pyautogui.center(_gmail_)
        pyautogui.click(formx, formy)
